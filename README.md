...
- [Cpp_Webserver](https://github.com/gtretiak/Cpp_Webserver): Non-blocking HTTP Web Server using a single-poll loop with NGINX-inspired configuration, file uploading & CGI support.
