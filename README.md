...
###### [Shell00](https://github.com/gtretiak/Shell_00) - designed to introduce fundamental Unix/Linux shell commands for navigating command-line environments, manipulating files, understanding file permissions, and working with Git repositories. ###### [Fract-ol](https://github.com/gtretiak/C_Fract_ol) - interactive fractal renderer (Mandelbrot, Julia & Multibrot sets). ###### [Push_swap](https://github.com/gtretiak/C_Push_swap) - optimized sorting algorithm using stacks. ###### [Pipex](https://github.com/gtretiak/C_Pipex) - Unix piping behavior with process control and file descriptor manipulation.
